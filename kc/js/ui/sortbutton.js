...
$.fn.elfindersortbutton = function (cmd) {
  ...
  return this.each(function () {
    var fm = cmd.fm,
      ...
      button = $(this)
        .addClass(
          'ui-state-default elfinder-button elfinder-menubutton elfiner-button-' +
            name,
        )
        ...
        .on('mouseenter mouseleave', function (e) {
          !button.hasClass(disabled) &&
            button.toggleClass(hover, e.type === 'mouseenter');
        })
        .on('click', function (e) {
      ...
      menu = $(
        '<div class="ui-front ui-widget ui-widget-content elfinder-button-menu elfinder-button-sort-menu ui-corner-all"/>',
      )
        .hide()
        .appendTo(fm.getUI())
        .on('mouseenter mouseleave', '.' + item, function (e) {
      ...
      update = function () {
        ...
        menu
          .children('.elfinder-sort-stick')
          .toggleClass(selected, fm.sortStickFolders);
        menu
          .children('.elfinder-sort-tree')
          .toggleClass(selected, fm.sortAlsoTreeview);
      },
    ...
    $(
      '<div class="' +
        ...
        ' ' +
        item +
        '-separated elfinder-sort-ext elfinder-sort-stick"><span class="ui-icon ui-icon-check"/>' +
      ...
      if (fm.ui.tree && fm.options.sortAlsoTreeview !== null) {
        $(
          '<div class="' +
            ...
            ' ' +
            item +
            '-separated elfinder-sort-ext elfinder-sort-tree"><span class="ui-icon ui-icon-check"/>' +
