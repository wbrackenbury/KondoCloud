...
$.fn.elfindertoast = function (opts, fm) {
  ...
  var defOpts = Object.assign(
    ...
    $.isPlainObject(fm.options.uiOptions.toast.defaults)
      ? fm.options.uiOptions.toast.defaults
      : {},
  );
  return this.each(function () {
    ...
    self
      ...
      .hide()
      .addClass('toast-' + opts.mode)
      .append(
        $('<div class="elfinder-toast-msg"/>').html(
          opts.msg.replace(/%([a-zA-Z0-9]+)%/g, function (m, m1) {
            return fm.i18n(m1);
          }),
        ),
      );
    ...
    if (opts.button) {
      self.append(
        $(
          ...
          .append(
            $('<span class="ui-button-text"/>').text(fm.i18n(opts.button.text)),
          )
          .on('mouseenter mouseleave', function (e) {
