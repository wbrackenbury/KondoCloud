...
$.fn.elfindernavbar = function (fm, opts) {
  ...
  this.not(".elfinder-navbar").each(function () {
    ...
    if (fm.UA.Touch) {
      ...
      if (typeof autoHide.navbar === "undefined") {
        autoHide.navbar =
          opts.autoHideUA &&
          opts.autoHideUA.length > 0 &&
          $.grep(opts.autoHideUA, function (v) {
        ...
        fm.one("init", function () {
          if (nav.children().length) {
            fm.uiAutoHide.push(function () {
              nav.stop(true, true).trigger("navhide", { duration: "slow", init: true });
            });
          }
        });
      }
      ...
      nav
        .on("navshow navhide", function (e, data) {
  ...
  // always be deleting the the tooltip
  $(".elfinder-navbar").on("mouseover", (e) => {
    e.stopPropagation();
