...
elFinder.prototype._options = {
  ...
  cdns: {
    ...
    prettify:
      "https://cdn.jsdelivr.net/gh/google/code-prettify@453bd5f51e61245339b738b1bbdd42d7848722ba/loader/run_prettify.js",
    ...
    amr:
      "https://cdn.jsdelivr.net/gh/yxl/opencore-amr-js@dcf3d2b5f384a1d9ded2a54e4c137a81747b222b/js/amrnb.js",
  },
  ...
  commandsOptions: {
    ...
    search: {
      ...
      searchTypes: {
        ...
        SearchMime: {
          // The key is search type that send to the connector
  ...
  uiOptions: {
    ...
    toolbar: [
      ...
      ["mkdir", "mkfile", "upload", "copy", "cut", "paste", "rm", "empty", "hide"],
   ...
   */
  dispInlineRegex:
    "^(?:(?:image|video|audio)|application/(?:x-mpegURL|dash+xml)|(?:text/plain|application/pdf)$)",
   ...
   */
  rawStringDecoder:
    typeof Encoding === "object" && $.isFunction(Encoding.convert)
      ? function (str) {
