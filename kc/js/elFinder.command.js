...
elFinder.prototype.command = function (fm) {
  ...
  this.setup = function (name, opts) {
    ...
    this.name = name;
    this.title = fm.messages["cmd" + name]
      ? fm.i18n("cmd" + name)
      : this.extendsCmd && fm.messages["cmd" + this.extendsCmd]
      ? fm.i18n("cmd" + this.extendsCmd)
      : name;
    ...
    $.each(
      Object.assign({}, self._handlers, self.handlers),
    ...
    if (this.disableOnSearch) {
      fm.bind("search searchend", function () {
        self._disabled =
          this.type === "search"
            ? true
            : !(this.alwaysEnabled || fm.isCommandEnabled(name));
  ...
  this.hashes = function (hashes) {
    return hashes
      ? $.grep(Array.isArray(hashes) ? hashes : [hashes], function (hash) {
  ...
  this.files = function (hashes) {
    ...
    return hashes
      ? $.map(Array.isArray(hashes) ? hashes : [hashes], function (hash) {
