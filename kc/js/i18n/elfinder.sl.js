...
(function (root, factory) {
  ...
  elFinder.prototype.i18.sl = {
    ...
    messages: {
      ...
      errJqui:
        'Napačna jQuery UI nastavitev. Selectable, draggable in droppable dodatki morajo biti vključeni.',
      ...
      errLocked:
        '"$1" je zaklenjen(a) in je ni možno preimenovati, premakniti ali izbrisati.',
      ...
      errPopup:
        'Brskalnik je preprečil prikaz (popup) okna. Za vpogled datoteke omogočite nastavitev v vašem brskalniku.',
      ...
      errArcSymlinks:
        'Zaradi varnostnih razlogov arhiva ki vsebuje "symlinks" ni možno odpakirati.',
      ...
      confirmRm:
        'Ste prepričani, da želite izbrisati datoteko?<br/>POZOR! Tega ukaza ni možno preklicati!',
