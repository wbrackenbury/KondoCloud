...
(function (root, factory) {
  ...
  elFinder.prototype.i18.tr = {
    translator:
      'I.Taskinoglu & A.Kaya &lt;alikaya@armsyazilim.com&gt;, Abdullah ELEN &lt;abdullahelen@msn.com&gt;, Osman KAYAN &lt;osmnkayan@gmail.com&gt;, alikayan95@gmail.com',
    language: 'Türkçe',
    direction: 'ltr',
    ...
    messages: {
      ...
      errJqui:
        'Geçersiz jQuery UI yapılandırması. Seçilebilir, sürükle ve bırak bileşenlerini içermelidir.',
      ...
      errLocked:
        '"$1" kilitli. Bu nedenle taşıma, yeniden adlandırma veya kaldırma yapılamıyor.',
      ...
      errPopup:
        'Tarayıcı popup penceresi açmayı engelledi. Tarayıcı ayarlarından dosya açmayı aktif hale getirin.',
      ...
      errNotReplace:
        '"$1" nesnesi bu konumda zaten var ve başka türde nesne ile değiştirilemez.', // new
      ...
      errReplByChild:
        '“$1” klasörü içerdiği bir öğe tarafından değiştirilemez.',
      errArcSymlinks:
        'Sembolik bağlantıları içeren arşivlerin açılması güvenlik nedeniyle reddedildi.', // edited 24.06.2012
      ...
      errFolderUpload:
        'Klasör yükleyebilmek için daha modern bir tarayıcıya ihtiyacınız var.', // from v2.1 added 26.6.2015
      errSearchTimeout:
        '"$1" araması zaman aşımına uğradı. Kısmi arama sonuçları listeleniyor.', // from v2.1 added 12.1.2016
      ...
      errRestore:
        'Çöp kutusundan geri yüklenemiyor. Geri yükleme notkası belirlenemiyor.', // from v2.1.24 added 3.5.2017
      ...
      confirmRm:
        'Dosyaları kaldırmak istediğinden emin misin?<br/>Bu işlem geri alınamaz!',
      ...
      confirmConvUTF8:
        "UTF-8 değil<br/>UTF-8'e dönüştürülsün mü?<br/>Dönüştürme sonrası kaydedebilmek için içeriğin UTF-8 olması gerekir.", // from v2.1 added 08.04.2014
      confirmNonUTF8:
        "Bu dosyanın karakter kodlaması tespit edilemedi. Düzenleme için geçici olarak UTF-8'e dönüştürülmesi gerekir.<br/>Lütfen bu dosyanın karakter kodlamasını seçin.", // from v2.1.19 added 28.11.2016
      confirmNotSave:
        'Düzenlenmiş içerik.<br/>Değişiklikleri kaydetmek istemiyorsanız son yapılanlar kaybolacak.', // from v2.1 added 15.7.2015
      ...
      openMultiConfirm:
        '$1 dosyalarını açmaya çalışıyorsunuz. Tarayıcıda açmak istediğinizden emin misiniz?', // from v2.1.12 added 5.14.2016
      ...
      emptyIncSearch:
        'Geçerli görünümde arama sonucu bulunamadı. Arama sonucunu genişletmek için \\APress [Enter]  yapın', // from v2.1.16 added 5.10.2016
      ...
      renameMultiple:
        '$1 seçilen öğeleri $2 gibi yeniden adlandırmak istediğinizden emin misiniz?</br>Bu geri alınamaz!', // from v2.1.31 added 4.12.2017
      ...
      reflectOnUnmount:
        'Herhangi bir değişiklik, bu birimi kaldırılıncaya kadar yansıtılmayacaktır.', // from v2.1.33 added 2.3.2018
      unmountChildren:
        'Bu cihaza monte edilen aşağıdaki birim (ler) de bağlanmamıştır. Çıkardığınızdan emin misiniz?', // from v2.1.33 added 5.3.2018
