...
(function (root, factory) {
  ...
  elFinder.prototype.i18.zh_CN = {
    translator:
      '翻译者 deerchao &lt;deerchao@gmail.com&gt;, Andy Hu &lt;andyhu7@yahoo.com.hk&gt;, Max Wen&lt;max.wen@qq.com&gt;, Kejun Chang &lt;changkejun@hotmail.com&gt;, LDMING &lt;china-live@live.cn&gt;, Andy Lee &lt;oraclei@126.com&gt;',
    language: '简体中文',
    direction: 'ltr',
    ...
    messages: {
      ...
      confirmConvUTF8:
        '文件不是UTF-8格式.<br/>转换为UTF-8吗？<br/>通过在转换后保存,内容变为UTF-8.', // from v2.1 added 08.04.2014
      confirmNonUTF8:
        '无法检测到此文件的字符编码.需要暂时转换此文件为UTF-8编码以进行编辑.<br/>请选择此文件的字符编码.', // from v2.1.19 added 28.11.2016
      ...
      editorConvNeedUpload:
        '转换后，必须上传条目URL或一个下载的文件,以保存转换后的文件.', //from v2.1.40 added 8.7.2018
      convertOn: '在 $1 站点上转换', // from v2.1.40 added 10.7.2018
      integrations: '集成', // from v2.1.40 added 11.7.2018
      integrationWith:
        '本 elFinder 集成以下外部服务.使用前请检查使用条款、隐私政策等.', // from v2.1.40 added 11.7.2018
