...
(function (root, factory) {
  ...
  elFinder.prototype.i18.id = {
    translator:
      'Suyadi &lt;1441177004009@student.unsika.ac.id&gt;, Ammar Faizi &lt;ammarfaizi2@gmail.com&gt;',
    ...
    messages: {
      ...
      errJqui:
        'Konfigurasi jQuery UI tidak valid. Komponen pemilih, penyeret dan penaruh harus disertakan.',
      ...
      errLocked:
        '"$1" ini terkunci dan tak dapat dipidahkan, diubah atau dihapus.',
      ...
      errPopup:
        'Peramban anda mencegah untuk membuka jendela munculan. Untuk dapat membuka berkas ini ubah pengaturan pada peramban anda.',
      ...
      errNotReplace:
        'Obyek "$1" sudah ada di lokasi ini dan tidak dapat ditimpa oleh obyek jenis lain.', // new
      ...
      errNoArchive:
        'Berkas ini bukan arsip atau arsip jenis ini tidak didukung.',
      errCmdNoSupport: 'Backend tidak mendukung perintah ini.',
      errReplByChild:
        'Folder “$1” tidak dapat ditimpa dengan berkas didalamnya.',
      errArcSymlinks:
        'Untuk keamanan tak diijinkan mengekstrak arsip berisi symlink atau jenis berkas yang tak diijinkan.', // edited 24.06.2012
      ...
      errNotUTF8Content:
        'Berkas "$1" tidak dalam format UTF-8 dan tidak dapat disunting.', // added 9.11.2011
      ...
      errFolderUpload:
        'Coba dengan browser yang modern, Jika akan mengupload folder.', // from v2.1 added 26.6.2015
      errSearchTimeout:
        'Waktu habis selama melakukan pencarian "$1". Hasil sementara.', // from v2.1 added 12.1.2016
      ...
      errRestore:
        'Tidak dapat mengembalikan berkas dari tempat sampah. Tujuan tidak ditemukan.', // from v2.1.24 added 3.5.2017
      ...
      confirmRm:
        'Anda yakin akan menghapus berkas?<br/>Ini tidak dapat kembalikan!',
      ...
      confirmConvUTF8:
        'Bukan UTF-8<br/>Konversi ke UTF-8?<br/>Konten akan berubah menjadi UTF-8 ketika disimpan dengan konversi.', // from v2.1 added 08.04.2014
      confirmNonUTF8:
      ...
      confirmNotSave:
        'Telah terjadi perubahan.<br/>Kehilangan perkerjaan jika kamu tidak menyimpan.', // from v2.1 added 15.7.2015
      ...
      emptyFolderLTap:
        'Folder kosong\\A Tekan yang lama untuk tambahkan berkas', // from v2.1.6 added 30.12.2015
      ...
      openMultiConfirm:
        'Anda mencoba membuka file $1. Apakah anda ingin membuka di browser?', // from v2.1.12 added 5.14.2016
      ...
      incSearchOnly:
        'Hanya pencarian bertamah untuk menampilkan tampilan sekarang', // from v2.1.13 added 6.30.2016
