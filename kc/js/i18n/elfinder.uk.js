...
(function (root, factory) {
  ...
  elFinder.prototype.i18.uk = {
    ...
    messages: {
      ...
      errJqui:
        'Неправильне налаштування jQuery UI. Відсутні компоненти: selectable, draggable, droppable.',
      ...
      errLocked:
        'Файл "$1" заблоковано - не можливо перемістити, перейменувати чи вилучити.',
      ...
      errPopup:
        'Браузер забороняє відкривати popup-вікно. Дозвольте у налаштування браузера, щоб відкрити файл.',
      ...
      errNoArchive:
        'Файл не є архівом, або є архівом, тип якого не підтримується.',
      errCmdNoSupport: 'Серверна частина не підтримує цієї команди.',
      errReplByChild:
        'Папка “$1” не може бути замінена елементом, який вона містить.',
      errArcSymlinks:
        'З міркувань безпеки заборонено розпаковувати архіви з символічними посиланнями.',
      ...
      errFolderUpload:
        'Використовуйте Google Chrome, якщо ви хочете завантажити папку', // from v2.1 added 26.6.2015
