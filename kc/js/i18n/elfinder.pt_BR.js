...
(function (root, factory) {
  ...
  elFinder.prototype.i18.pt_BR = {
    translator:
      'Leandro Carvalho &lt;contato@leandrowebdev.net&gt;, Wesley Osorio&lt;wesleyfosorio@hotmail.com&gt;, Fernando H. Bandeira &lt;fernando.bandeira94@gmail.com&gt;, Gustavo Brito &lt;britopereiragustavo@gmail.com&gt;',
    language: 'Português',
    direction: 'ltr',
    ...
    messages: {
      ...
      errJqui:
        'Configuração inválida do JQuery UI. Verifique se os componentes selectable, draggable e droppable estão incluídos.',
      ...
      errPopup:
        "O seu navegador está bloqueando popup's. Para abrir o arquivo, altere esta opção no seu Navegador.",
      ...
      errNotReplace:
        'Objeto "$1" já existe neste local e não pode ser substituído por um objeto com outro tipo.', // new
      ...
      errReplByChild:
        'A pasta “$1” não pode ser substituída por um item que contém.',
      errArcSymlinks:
        'Por razões de segurança, negada a permissão para descompactar arquivos que contenham links ou arquivos com nomes não permitidos.', // edited 24.06.2012
      ...
      errNotUTF8Content:
        'Arquivo "$1" não está em UTF-8 e não pode ser editado.', // added 9.11.2011
      ...
      errCreatingTempDir:
        'Não foi possível criar um diretório temporário: "$1"',
      errFtpDownloadFile:
        'Não foi possível fazer o download do arquivo do FTP: "$1"',
      errFtpUploadFile:
        'Não foi possível fazer o upload do arquivo para o FTP: "$1"',
      ...
      errFolderUpload:
        'Tente utilizar o Google Chrome, se você deseja enviar uma pasta.', // from v2.1 added 26.6.2015
      errSearchTimeout:
        'Tempo limite atingido para a busca "$1". O resultado da pesquisa é parcial.', // from v2.1 added 12.1.2016
      ...
      errRestore:
        'Não foi possível restaurar a partir do lixo. Não é possível identificar o destino da restauração.', // from v2.1.24 added 3.5.2017
      ...
      confirmRm:
        'Você tem certeza que deseja remover os arquivos?<br />Isto não pode ser desfeito!',
      ...
      confirmConvUTF8:
        'Não está em UTF-8<br/>Converter para UTF-8?<br/>Conteúdo se torna UTF-8 após salvar as conversões.', // from v2.1 added 08.04.2014
      confirmNonUTF8:
        'Não foi possível detectar a codificação de caracteres deste arquivo. Ele precisa ser convertido temporariamente em UTF-8 para edição. Por favor, selecione a codificação de caracteres deste arquivo.', // from v2.1.19 added 28.11.2016
      confirmNotSave:
        'Isto foi modificado.<br/>Você vai perder seu trabalho caso não salve as mudanças.', // from v2.1 added 15.7.2015
      ...
      openMultiConfirm:
        'Você está tentando abrir os arquivos $1. Tem certeza de que deseja abrir no navegador?', // from v2.1.12 added 5.14.2016
      emptySearch:
        'Os resultados da pesquisa estão vazios no destino da pesquisa.', // from v2.1.12 added 5.16.2016
      ...
      emptyIncSearch:
        'Os resultados da pesquisa estão vazios na exibição atual.\\APressione [Enter] para expandir o alvo da pesquisa.', // from v2.1.16 added 5.10.2016
      emptyLetSearch:
        'Os resultados da pesquisa da primeira letra estão vazios na exibição atual.', // from v2.1.23 added 24.3.2017
      ...
      tooManyToTrash:
        'São muitos itens, portanto não podem ser jogados no lixo.', // from v2.1.25 added 9.6.2017
      ...
      renameMultiple:
        'Tem certeza de que deseja renomear $1 itens selecionados como $2?<br/>Isto não poderá ser desfeito!', // from v2.1.31 added 4.12.2017
      ...
      reflectOnImmediate:
        'Todas as alterações serão refletidas imediatamente no arquivo.', // from v2.1.33 added 2.3.2018
      reflectOnUnmount:
        'Quaisquer alterações não serão refletidas até desmontar este volume.', // from v2.1.33 added 2.3.2018
      unmountChildren:
        'O(s) seguinte(s) volume(s) montado neste volume também desmontado. Você tem certeza que quer desmontá-lo(s)?', // from v2.1.33 added 5.3.2018
      ...
      editorConvNoApi:
        'Como a conversão por API não está disponível no momento, faça a conversão no site.', //from v2.1.40 added 8.7.2018
      editorConvNeedUpload:
        'Após a conversão, você deve fazer o upload com o URL do item ou um arquivo baixado para salvar o arquivo convertido.', //from v2.1.40 added 8.7.2018
      convertOn: 'Converter no site $1', // from v2.1.40 added 10.7.2018
      integrations: 'Integrações', // from v2.1.40 added 11.7.2018
      integrationWith:
        'Este elFinder possui os seguintes serviços externos integrados. Por favor, verifique os termos de uso, política de privacidade, etc. antes de usá-lo.', // from v2.1.40 added 11.7.2018
      ...
      exportToSave:
        'Este item não pode ser salvo. Para evitar perder as edições, você precisa exportar para o seu PC.', // from v2.1.44 added 1.12.2018
