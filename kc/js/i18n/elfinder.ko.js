...
(function (root, factory) {
  ...
  elFinder.prototype.i18.ko = {
    translator:
      'Hwang Ahreum; &lt;luckmagic@naver.com&gt;, Park Sungyong; &lt;sungyong@gmail.com&gt;, Yeonjeong Woo &lt;eat_sweetly@naver.com&gt;',
    language: 'Korea-한국어',
    direction: 'ltr',
    ...
    messages: {
      ...
      errJqui:
        'jQuery UI 환경설정이 올바르지 않습니다. 선택가능하거나,드래그앤드롭가능한 컴포넌트가 포함되어야합니다',
      errNode: 'elFinder를 생성하기 위해서는 DOM Element를 요구합니다',
      errURL:
        'elFinder 환경설정이 올바르지 않습니다! URL 옵션이 설정되지 않았습니다',
      ...
      errPopup:
        '브라우저에서 팝업을 차단하였습니다.팝업을 허용하려면 브라우저 옵션을 변경하세요',
      ...
      errArcSymlinks:
        '보안을 위해 시스템 호출을 포함한 압축파일인지를 분석합니다', // edited 24.06.2012
      ...
      errNotUTF8Content:
        '파일 "$1"은 UTF-8 형식이 아니어서 편집할 수 없습니다.', // added 9.11.2011
      ...
      errSearchTimeout:
        '"$1" 검색에 시간 초과하였습니다.  검색결과는 전체가 아닙니다.', // from v2.1 added 12.1.2016
      errReauthRequire: '재인증이 필요합니다.', // from v2.1.10 added 24.3.2016
      errMaxTargets: '선택가능한 최대 갯수는 $1개입니다.', // from v2.1.17 added 17.10.2016
      errRestore:
        '휴지통에서 복구할 수 없습니다.  복원할 위치 확인할 수 없습니다.', // from v2.1.24 added 3.5.2017
      errEditorNotFound:
        '이 형식의 파일을 편집할 수 없는 에디터를 발견할 수 없습니다.', // from v2.1.25 added 23.5.2017
      ...
      confirmReq: '확인',
      confirmRm:
        '이 파일을 정말 삭제 하겠습니까?<br/>실행 후 되돌릴 수 없습니다!',
      confirmRepl: '파일을 덮어쓰겠습니까?',
      confirmRest: '이미 있는 항목을 휴지통에 있는 이 것으로 교체하시겠습니까?', // fromv2.1.24 added 5.5.2017
      confirmConvUTF8:
        'UTF-8이 아닙니다<br/>UTF-8로 변환할까요?<br/>변환후 저장하면 UTF-8로 됩니다.', // from v2.1 added 08.04.2014
      confirmNonUTF8:
        '이 파일의 인코딩 타입을 알아내지 못했습니다. 편집하려면 임시로 UTF-8로 변환해야 합니다.<br/>어떤 인코딩을 할지 선택하십시오.', // from v2.1.19 added 28.11.2016
      confirmNotSave:
        '변경한 부분이 있습니다.<br/>저장하지 않는다면 현재 작업중인 내용을 잃을 수 있습니다.', // from v2.1 added 15.7.2015
      ...
      dropPasteFiles:
        '파일을 끌어오거나, 클립보드의 URL이나 이미지들을 붙여넣으십시오.', // from v2.1 added 07.04.2014
      ...
      emptyIncSearch:
        '현재 뷰에는 검색결과가 없습니다.\\A[Enter]를 눌러 검색 대상을 확장하십시오.', // from v2.1.16 added 5.10.2016
      ...
      renameMultiple:
        '선택한 $1 을(를) $2와 같이 바꾸겠습니까?<br/>이 작업은 원복할 수 없습니다!', // from v2.1.31 added 4.12.2017
      ...
      reflectOnUnmount:
        '이 볼륨을 언마운트할 때까지는 어떤 변경도 반영되지 않습니다.', // from v2.1.33 added 2.3.2018
      unmountChildren:
        '아래의 볼륨들도 이 볼륨과 함께 언마운트됩니다. 계속하시겠습니까?', // from v2.1.33 added 5.3.2018
