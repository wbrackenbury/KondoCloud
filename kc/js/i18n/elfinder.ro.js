...
(function (root, factory) {
  ...
  elFinder.prototype.i18.ro = {
    ...
    messages: {
      ...
      errJqui:
        'Configurație jQuery UI necunoscută. Componentele selectable, draggable și droppable trebuie să fie incluse.',
      ...
      errPopup:
        'Browserul tău a prevenit deschiderea ferestrei popup. Pentru a deschide fișierul permite deschidere ferestrei.',
      ...
      errNotReplace:
        'Obiectul "$1" există deja în acest loc și nu poate fi înlocuit de un obiect de alt tip.', // new
      ...
      errNoArchive:
        'Fișierul nu este o arhiva sau este o arhivă de un tip necunoscut.',
      errCmdNoSupport: 'Backend-ul nu suportă această comandă.',
      errReplByChild:
        'Dosarul “$1” nu poate fi înlocuit de un element pe care el îl conține.',
      errArcSymlinks:
        'Din motive de securitate, arhiva nu are voie să conțină symlinks sau fișiere cu nume interzise.', // edited 24.06.2012
      ...
      errNotUTF8Content:
        'Fișierul "$1" nu folosește UTF-8 și nu poate fi editat.', // added 9.11.2011
      ...
      confirmRm:
        'Ești sigur că vrei să ștergi fișierele?<br/>Acțiunea este ireversibilă!',
      confirmRepl: 'Înlocuiește fișierul vechi cu cel nou?',
      confirmConvUTF8:
        'Nu este în UTF-8<br/>Convertim la UTF-8?<br/>Conținutul devine UTF-8 după salvarea conversiei.', // from v2.1 added 08.04.2014
      confirmNotSave:
        'Au avut loc modificări.<br/>Dacă nu salvezi se vor pierde modificările.', // from v2.1 added 15.7.2015
