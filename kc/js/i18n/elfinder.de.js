...
(function (root, factory) {
  ...
  elFinder.prototype.i18.de = {
    translator:
      'JPG & Mace &lt;dev@flying-datacenter.de&gt;, tora60 from pragmaMx.org, Timo-Linde &lt;info@timo-linde.de&gt;, osworx.net, Maximilian Schwarz &lt;info@deefuse.de&gt;, SF Webdesign &lt;webdesign@stephan-frank.de&gt;',
    language: 'Deutsch',
    direction: 'ltr',
    ...
    messages: {
      ...
      errURL:
        'Ungültige elFinder Konfiguration! Die URL-Option ist nicht gesetzt.',
      ...
      errLocked:
        '"$1" ist gesperrt und kann nicht umbenannt, verschoben oder gelöscht werden.',
      ...
      errNotReplace:
        'Das Objekt "$1" existiert bereits an dieser Stelle und kann nicht durch ein Objekt eines anderen Typs ersetzt werden.', // new
      ...
      errNoArchive:
        'Bei der Datei handelt es sich nicht um ein Archiv, oder der Archivtyp wird nicht unterstützt.',
      errCmdNoSupport: 'Das Backend unterstützt diesen Befehl nicht.',
      errReplByChild:
        'Der Ordner "$1" kann nicht durch etwas ersetzt werden, das ihn selbst enthält.',
      errArcSymlinks:
        'Aus Sicherheitsgründen ist es verboten, ein Archiv mit symbolischen Links zu extrahieren.', // edited 24.06.2012
      errArcMaxSize:
        'Die Archivdateien übersteigen die maximal erlaubte Größe.',
      ...
      errNotUTF8Content:
        'Die Datei "$1" ist nicht im UTF-8-Format und kann nicht editiert werden.', // added 9.11.2011
      ...
      errSessionExpires:
        'Diese Sitzung ist aufgrund von Inaktivität abgelaufen.',
      errCreatingTempDir:
        'Erstellung des temporären Ordners nicht möglich: "$1"',
      ...
      errFolderUpload:
        'Versuchen Sie es mit Google Chrome, wenn Sie einen Ordner hochladen möchten.', // from v2.1 added 26.6.2015
      errSearchTimeout:
        'Zeitüberschreitung während der Suche nach "$1". Suchergebnis ist unvollständig.', // from v2.1 added 12.1.2016
      ...
      errRestore:
        'Konnte nicht von Mülleimer wiederherstellen. Konnte Ziel für wiederherstellung nicht finden.', // from v2.1.24 added 3.5.2017
      ...
      confirmRest:
        'Vorhandenes Element durch das Element im Papierkorb ersetzen?', // fromv2.1.24 added 5.5.2017
      confirmConvUTF8:
        'Nicht in UTF-8<br/>Zu UTF-8 konvertieren?<br/>Inhalte werden zu UTF-8 konvertiert, wenn Sie speichern.', // from v2.1 added 08.04.2014
      confirmNonUTF8:
        'Die Zeichencodierung dieser Datei konnte nicht erkannt werden. Es muss vorübergehend in UTF-8 zur Bearbeitung konvertiert werden. <br/> Bitte wähle eine Zeichenkodierung dieser Datei aus.', // from v2.1.19 added 28.11.2016
      confirmNotSave:
        'Die Datei wurde geändert.<br/>Sie werden die Änderungen verlieren, wenn Sie nicht speichern.', // from v2.1 added 15.7.2015
      confirmTrash:
        'Sind Sie sicher, dass sie die Elemente in den Mülleimer bewegen wollen?', //from v2.1.24 added 29.4.2017
      ...
      emptyFolderDrop:
        'Der Ordner ist leer\\A Fügen Sie Elemente durch Ziehen hinzu', // from v2.1.6 added 30.12.2015
      emptyFolderLTap:
        'Der Ordner ist leer\\A Fügen Sie Elemente durch langes Tippen hinzu', // from v2.1.6 added 30.12.2015
      ...
      openMultiConfirm:
        'Sie versuchen, die $1 Dateien zu öffnen. Sind Sie sicher, dass sie im Browser öffnen wollen ?', // from v2.1.12 added 5.14.2016
      ...
      incSearchOnly:
        'Inkrementelle Suche bezieht sich nur auf die aktuelle Ansicht.', // from v2.1.13 added 6.30.2016
      ...
      emptyLetSearch:
        'Die Ergebnisse der ersten Buchstabensuche sind in der aktuellen Ansicht leer.', // from v2.1.23 added 24.3.2017
      ...
      tooManyToTrash:
        'Es sind zu viele Elemente, also kann es nicht in den Papierkorb.', // from v2.1.25 added 9.6.2017
      ...
      clearBrowserData:
        'Initialisiere die Einstellungen, welche in diesem Browser gespeichert sind', // from v2.1.26 added 28.6.2017
      ...
      renameMultiple:
        'Sind Sie sicher, dass Sie $1 ausgewählte Elemente in $2 umbenennen möchten?<br/>Das kann nicht rückgängig gemacht werden!', // from v2.1.31 added 4.12.2017
      ...
      reflectOnUnmount:
        'Alle Änderungen werden nicht angewendet, bis Sie dieses Volume entfernen.', // from v2.1.33 added 2.3.2018
      unmountChildren:
        'Die folgenden Datenträger, die auf diesem Datenträger eingehängt sind, werden ebenfalls ausgehängt. Sind Sie sicher, dass Sie alle aushängen wollen?', // from v2.1.33 added 5.3.2018
