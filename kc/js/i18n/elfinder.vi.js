...
(function (root, factory) {
  ...
  elFinder.prototype.i18.vi = {
    translator:
      'Chung Thủy f &lt;chungthuyf@gmail.com&gt;,Son Nguyen &lt;son.nguyen@catalyst.net.nz&gt;',
    ...
    messages: {
      ...
      errJqui:
        'Cấu hình jQueryUI không hợp lệ. Các thành phần lựa chọn, kéo và thả phải được bao gồm.',
      errNode: 'elFinder đòi hỏi phần tử DOM phải được tạo ra.',
      errURL:
        'Cấu hình elFinder không hợp lệ! URL không được thiết lập tùy chọn.',
      ...
      errLocked:
        '"$1" đã bị khóa và không thể đổi tên, di chuyển hoặc loại bỏ.',
      ...
      errNoArchive:
        'Tập tin không phải là lưu trữ hoặc có kiểu lưu trữ không được hỗ trợ.',
      errCmdNoSupport: 'Backend không hỗ trợ lệnh này.',
      errReplByChild:
        'Thư mục "$1" không thể được thay thế bằng một mục con mà nó chứa.',
      errArcSymlinks:
        'Vì lý do bảo mật, từ chối giải nén tập tin lưu trữ có chứa liên kết mềm.',
