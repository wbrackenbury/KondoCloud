...
(function (root, factory) {
  ...
  elFinder.prototype.i18.hr = {
    ...
    messages: {
      ...
      errJqui:
        'Kriva jQuery UI konfiguracija. Selectable, draggable, i droppable komponente moraju biti uključene.',
      ...
      errLocked:
        '"$1" je zaključan i ne može biti preimenovan, premješten ili obrisan.',
      ...
      errUploadTemp:
        'Ne mogu napraviti privremeni dokument za prijenos na server', // from v2.1 added 26.09.2015
      errNotReplace:
      ...
      emptyFolderLTap:
        'Mapa je prazna\\A Pritisni dugo za dodavanje dokumenata', // from v2.1.6 added 30.12.2015
