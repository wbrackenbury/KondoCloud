...
(function (root, factory) {
  ...
  elFinder.prototype.i18.fo = {
    ...
    messages: {
      ...
      errJqui:
        'Ógildig jQuery UI konfiguratión. Vælbærar, sum kunnu hálast runt og kunnu sleppast skulu takast við.',
      ...
      errPopup:
        'Kagin forðaði í at opna eitt popup-vindeyga. Fyri at opna fíluna, aktivera popup-vindeygu í tínum kaga stillingum.',
      ...
      errMkOutLink:
        "Ikki ført fyri at stovna leinkju til uttanfyri 'volume' rót.", // from v2.1 added 03.10.2015
      ...
      errNotReplace:
        'Lutur "$1" finst longu á hesum stað og can ikki skiftast út av lutið av øðrum slag.', // new
      ...
      errNoArchive:
        'Fílan er ikki eitt arkiv ella er ikki eitt stuðla arkiva slag.',
      errCmdNoSupport: 'Backend stuðlar ikki hesi boð.',
      errReplByChild:
        'appan "$1" kann ikki erstattast av einari vøru, hon inniheldur.',
      errArcSymlinks:
        'Av trygdarávum grundum, noktaði skipanin at pakka út arkivir ið innihalda symlinks ella fílur við nøvn ið ikki eru loyvd.', // edited 24.06.2012
      ...
      confirmRm:
        'Ert tú vísur í at tú ynskir at strika fílarnar?<br/>Hetta kann ikki angrast!',
      confirmRepl: 'Erstatta gomlu fílu við nýggja?',
      confirmConvUTF8: 'Brúka á øll', // from v2.1 added 08.04.2014
      confirmNotSave:
        'Er blivi rættað.<br/>Missir sínar broytingar um tú ikki goymir.', // from v2.1 added 15.7.2015
