...
(function (root, factory) {
  ...
  elFinder.prototype.i18.sv = {
    ...
    messages: {
      ...
      errJqui:
        'Felaktig jQuery UI konfiguration. Komponenterna selectable, draggable och droppable måste vara inkluderade.',
      ...
      errPopup:
        'Webbläsaren hindrade popup-fönstret att öppnas. Ändra i webbläsarens inställningar för att kunna öppna filen.',
      ...
      errReplByChild:
        'Mappen “$1” kan inte ersättas av ett objekt den innehåller.',
      errArcSymlinks:
        'Av säkerhetsskäl nekas arkivet att packas upp då det innehåller symboliska länkar eller filer med ej tillåtna namn.', // edited 24.06.2012
      ...
      confirmRm:
        'Är du säker på att du vill ta bort filer? <br/> Detta kan inte ångras!',
