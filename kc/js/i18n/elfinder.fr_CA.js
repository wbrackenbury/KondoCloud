...
(function (root, factory) {
  ...
  elFinder.prototype.i18.fr_CA = {
    translator:
      'Régis Guyomarch &lt;regisg@gmail.com&gt;, Benoit Delachaux &lt;benorde33@gmail.com&gt;, Jonathan Grunder &lt;jonathan.grunder@gmail.com&gt;',
    language: 'française',
    direction: 'ltr',
    ...
    messages: {
      ...
      errURL:
        "Mauvaise configuration d'elFinder ! L'option URL n'a pas été définie.",
      ...
      errMkOutLink:
        'Impossible de créer un lien en dehors du volume principal.', // from v2.1 added 03.10.2015
      ...
      errUploadTemp:
        'Impossible de créer un fichier temporaire pour transférer les fichiers.', // from v2.1 added 26.09.2015
      errNotReplace:
        'L\'objet "$1" existe déjà à cet endroit et ne peut être remplacé par un objet d\'un type différent.', // new
      ...
      errArcSymlinks:
        "Par mesure de sécurité, il est défendu d'extraire une archive contenant des liens symboliques ou des noms de fichier non autorisés.", // edited 24.06.2012
      errArcMaxSize:
      ...
      errNotUTF8Content:
        'Le fichier "$1" n\'est pas en UTF-8, il ne peut être édité.', // added 9.11.2011
      ...
      errFtpDownloadFile:
        'Impossible de télécharger le file depuis l\'accès FTP : "$1"',
      errFtpUploadFile:
        'Impossible d\'envoyer le fichier vers l\'accès FTP : "$1"',
      errFtpMkdir:
        'Impossible de créer un répertoire distant sur l\'accès FTP :"$1"',
      ...
      errSearchTimeout:
        'Délai d’attente dépassé pour la recherche "$1". Le résultat de la recherche est partiel.', // from v2.1 added 12.1.2016
      errReauthRequire: 'Réauthorisation requise.', // from v2.1.10 added 24.3.2016
      errMaxTargets:
        "Le nombre maximal d'éléments pouvant être sélectionnés est $1.", // from v2.1.17 added 17.10.2016
      errRestore:
        "Impossible de restaurer la corbeille. La destination de la restauration n'a pu être identifiée.", // from v2.1.24 added 3.5.2017
      errEditorNotFound:
        "Aucun éditeur n'a été trouvé pour ce type de fichier.", // from v2.1.25 added 23.5.2017
      ...
      confirmRm:
        'Êtes-vous certain de vouloir supprimer les éléments ?<br/>Cela ne peut être annulé !',
      confirmRepl: "Supprimer l'ancien fichier par le nouveau ?",
      confirmRest:
        "Remplacer l'élément existant par l'élément de la corbeille ?", // fromv2.1.24 added 5.5.2017
      confirmConvUTF8:
        "L'encodage n'est pas UTf-8<br/>Convertir en UTF-8 ?<br/>Les contenus deviendront UTF-8 en sauvegardant après la conversion.", // from v2.1 added 08.04.2014
      confirmNonUTF8:
        "Impossible de détecter l'encodage de ce fichier. Pour être modifié, il doit être temporairement convertit en UTF-8.<br/>Veuillez s'il vous plaît sélectionner un encodage pour ce fichier.", // from v2.1.19 added 28.11.2016
      confirmNotSave:
        'Ce fichier a été modifié.<br/>Les données seront perdues si les changements ne sont pas sauvegardés.', // from v2.1 added 15.7.2015
      confirmTrash:
        'Êtes-vous certain de vouloir déplacer les éléments vers la corbeille?', //from v2.1.24 added 29.4.2017
      ...
      emptyFolderDrop:
        'Le dossier est vide.\\ Glissez-déposez pour ajouter des éléments.', // from v2.1.6 added 30.12.2015
      emptyFolderLTap:
        'Le dossier est vide.\\ Appuyez longuement pour ajouter des éléments.', // from v2.1.6 added 30.12.2015
      ...
      openMultiConfirm:
        'Vous allez ouvrir $1 fichiers. Êtes-vous sûr de vouloir les ouvrir dans le navigateur ?', // from v2.1.12 added 5.14.2016
      ...
      incSearchOnly:
        'Recherche incrémentale disponible uniquement pour la vue active.', // from v2.1.13 added 6.30.2016
      ...
      emptyIncSearch:
        'Aucun résultat trouvé.\\AAppuyez sur [Entrée] pour développer la cible de recherche.', // from v2.1.16 added 5.10.2016
      emptyLetSearch:
        'Aucun résultat trouvé pour la recherche par première lettre.', // from v2.1.23 added 24.3.2017
      ...
      clearBrowserData:
        'Initialisation des configurations sauvegardées dans ce navigateur', // from v2.1.26 added 28.6.2017
      ...
      renameMultiple:
        "Êtes-vous sûr de vouloir renommer les éléments sélectionnés $1 en $2 ?<br/>L'action est définitive !", // from v2.1.31 added 4.12.2017
      ...
      reflectOnImmediate:
        "Les changements seront immédiatement appliqués à l'archive.", // from v2.1.33 added 2.3.2018
      reflectOnUnmount:
        "Aucun changement ne sera appliqué tant que ce volume n'a pas été démonté.", // from v2.1.33 added 2.3.2018
      unmountChildren:
        'Le(s) volume(s) suivant(s) montés sur ce volume seront également démontés. Êtes-vous sûr de vouloir le démonter ?', // from v2.1.33 added 5.3.2018
