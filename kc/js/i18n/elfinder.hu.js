...
(function (root, factory) {
  ...
  elFinder.prototype.i18.hu = {
    ...
    messages: {
      ...
      errLocked:
        '"$1" zárolás alatt van, és nem lehet átnevezni, mozgatni vagy eltávolítani.',
      ...
      errPopup:
        'A böngésző megakadályozta egy felugró ablak megnyitását. A fájl megnyitását tegye lehetővé a böngésző beállitásaiban.',
      ...
      errMkOutLink:
        'Hivatkozás létrehozása a root köteten kívül nem megengedett.', // from v2.1 added 03.10.2015
      ...
      errUploadTotalSize:
        'Az adat meghaladja a maximálisan megengedett méretet.', // old name - errMaxSize
      ...
      errUploadTemp:
        'Sikertelen az ideiglenes fájl léterhezozása feltöltéshez.', // from v2.1 added 26.09.2015
      errNotReplace:
        'Az objektum "$1" már létezik ezen a helyen, és nem lehet cserélni másik típusra', // new
