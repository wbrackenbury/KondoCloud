...
(function (root, factory) {
  ...
  elFinder.prototype.i18.nl = {
    translator:
      'Barry vd. Heuvel &lt;barry@fruitcakestudio.nl&gt;, Patrick Tingen &lt;patrick@tingen.net&gt;',
    language: 'Nederlands',
    direction: 'ltr',
    ...
    messages: {
      ...
      errNotReplace:
        'Object "$1" bestaat al op deze locatie en kan niet vervangen worden door een ander type object', // new
      ...
      errArcSymlinks:
        'Om veiligheidsredenen kan een bestand met symlinks of bestanden met niet toegestane namen niet worden uitgepakt ', // edited 24.06.2012
      ...
      errNotUTF8Content:
        'Bestand "$1" is niet in UTF-8 and kan niet aangepast worden', // added 9.11.2011
      ...
      errArchiveExec:
        'Er is een fout opgetreden bij het archivering van de bestanden: "$1" ',
      errExtractExec:
        'Er is een fout opgetreden bij het uitpakken van de bestanden: "$1" ',
      ...
      errFolderUpload:
        'Probeer een moderne browser als je bestanden wil uploaden', // from v2.1 added 26.6.2015
      errSearchTimeout:
        'Time-out bij zoeken naar "$1". Zoekresulataat is niet compleet', // from v2.1 added 12.1.2016
      ...
      errRestore:
        'Kan niet herstellen uit prullenbak, weet niet waar het heen moet', // from v2.1.24 added 3.5.2017
      ...
      confirmConvUTF8:
        'Niet in UTF-8<br/>Converteren naar UTF-8?<br/>De inhoud wordt UTF-8 door op te slaan na de conversie', // from v2.1 added 08.04.2014
      confirmNonUTF8:
      ...
      confirmNotSave:
        'Het is aangepast.<br/>Wijzigingen gaan verloren als je niet opslaat', // from v2.1 added 15.7.2015
      ...
      openMultiConfirm:
        'Je probeert het $1 bestanden te openen. Weet je zeker dat je dat in je browser wil doen?', // from v2.1.12 added 5.14.2016
      ...
      emptyIncSearch:
        'Zoekresultaten zijn leeg in actuele view\\ADruk [Enter] om zoekgebied uit te breiden', // from v2.1.16 added 5.10.2016
      ...
      renameMultiple:
        'Weet je zeker dat je $1 items wil hernoemen naar $2?<br/>Dit kan niet ongedaan worden gemaakt!', // from v2.1.31 added 4.12.2017
      ...
      reflectOnUnmount:
        'Aanpassingen worden pas toegepast na re-mount van dit volume', // from v2.1.33 added 2.3.2018
      unmountChildren:
        'Deze volume(s) worden ook unmounted. Weet je het zeker?', // from v2.1.33 added 5.3.2018
      ...
      editorConvNoApi:
        'Conversie via API is niet beschikbaar, converteer aub op de website', //from v2.1.40 added 8.7.2018
      ...
      integrationWith:
        'Deze elFinder heeft de volgende externe services. Controleer de voorwaarden, privacy policy, etc. voor gebruik', // from v2.1.40 added 11.7.2018
      ...
      exportToSave:
        'Dit item kan niet worden opgeslagen, exporteer naar je pc om wijzingen te bewaren', // from v2.1.44 added 1.12.2018
