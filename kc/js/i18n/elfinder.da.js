...
(function (root, factory) {
  ...
  elFinder.prototype.i18.da = {
    ...
    messages: {
      ...
      errJqui:
        'Ugyldig jQuery UI konfiguration. Valgbare, som kan trækkes rundt og droppable komponenter skal medtages.',
      ...
      errLocked:
        '"$1" er låst og kan ikke blive omdøbt, flyttet eller slettet.',
      ...
      errPopup:
        'Browseren forhindrede åbne popup-vindue. For at åbne filen aktivere popup-vinduer i browserindstillinger.',
      ...
      errUploadTotalSize:
        'Dataen overskrider den maksimalt tilladte størrelse.',
      ...
      errNoArchive:
        'Filen er ikke et arkiv eller har ikke-understøttet arkiv type.',
      errCmdNoSupport: 'Backend understøtter ikke denne kommando.',
      errReplByChild:
        'Mappen "$1" kan ikke erstattes af en vare, den indeholder.',
      errArcSymlinks:
        'Af sikkerhedsmæssige årsager nægtede at udpakke arkiver der indeholder symlinks eller filer med ikke tilladte navne.', // edited 24.06.2012
      ...
      errNotUTF8Content:
        'Filen "$1" er ikke i UTF-8 og kan ikke blive redigeret.', // added 9.11.2011
      ...
      confirmRm:
        'Er du sikker på du vil slette valgte filer?<br/>Dette kan ikke blive fortrudt!',
