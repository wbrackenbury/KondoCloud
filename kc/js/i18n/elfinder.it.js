...
(function (root, factory) {
  ...
  elFinder.prototype.i18.it = {
    translator:
      'Alberto Tocci (alberto.tocci@gmail.com), Claudio Nicora (coolsoft.ita@gmail.com), Stefano Galeazzi &lt;stefano.galeazzi@probanet.it&gt;, Thomas Camaran &lt;camaran@gmail.com&gt;',
    language: 'Italiano',
    direction: 'ltr',
    ...
    messages: {
      ...
      errJqui:
        'Configurazione JQuery UI non valida. Devono essere inclusi i plugin Selectable, Draggable e Droppable.',
      ...
      errLocked:
        '"$1" è bloccato e non può essere rinominato, spostato o eliminato.',
      ...
      errTrgFolderNotFound:
        'La cartella di destinazione"$1" non è stata trovata.',
      errPopup:
        'Il tuo Browser non consente di aprire finestre di pop-up. Per aprire il file abilita questa opzione nelle impostazioni del tuo Browser.',
      ...
      errMkOutLink:
        "Impossibile creare un link all'esterno della radice del volume.", // from v2.1 added 03.10.2015
      ...
      errUploadTotalSize:
        'La dimensione totale dei file supera il limite massimo consentito.', // old name - errMaxSize
      errUploadFileSize:
        'Le dimensioni del file superano il massimo consentito.', //  old name - errFileMaxSize
      ...
      errNotReplace:
        'L\'oggetto "$1" esiste già in questa cartella e non può essere sostituito con un oggetto di un tipo differente.', // new
      ...
      errReplByChild:
        'La cartella $1 non può essere sostituita da un oggetto in essa contenuto.',
      errArcSymlinks:
        'Per questioni di sicurezza non è possibile estrarre archivi che contengono collegamenti..', // edited 24.06.2012
      errArcMaxSize:
        "La dimensione dell'archivio supera le massime dimensioni consentite.",
      ...
      errNotUTF8Content:
        'Il file "$1" non è nel formato UTF-8 e non può essere modificato.', // added 9.11.2011
      ...
      errSearchTimeout:
        'Timeout durante la ricerca di "$1". I risultati della ricerca sono parziali.', // from v2.1 added 12.1.2016
      ...
      errRestore:
        'Impossibile ripristinare dal cestino: destinazione di ripristino non trovata.', // from v2.1.24 added 3.5.2017
      errEditorNotFound:
        'Impossibile trovare un editor per questo tipo di file.', // from v2.1.25 added 23.5.2017
      ...
      confirmRm:
        "Sei sicuro di voler eliminare i file?<br />L'operazione non è reversibile!",
      confirmRepl: 'Sostituire i file ?',
      confirmRest: "Rimpiazza l'oggetto esistente con quello nel cestino?", // fromv2.1.24 added 5.5.2017
      confirmConvUTF8:
        'Non in formato UTF-8<br/>Convertire in UTF-8?<br/>Il contenuto diventerà UTF-8 salvando dopo la conversione.', // from v2.1 added 08.04.2014
      confirmNonUTF8:
        "La codifica caratteri di questo file non può essere determinata. Sarà temporaneamente convertito in UTF-8 per l'editting.<br/>Per cortesia, selezionare la codifica caratteri per il file.", // from v2.1.19 added 28.11.2016
      confirmNotSave:
        'Il contenuto è stato modificato.<br/>Le modifiche andranno perse se non si salveranno.', // from v2.1 added 15.7.2015
      ...
      emptyFolderDrop:
        'La cartella è vuota\\A Trascina e rilascia per aggiungere elementi', // from v2.1.6 added 30.12.2015
      emptyFolderLTap:
        'La cartella è vuota\\A Premi a lungo per aggiungere elementi', // from v2.1.6 added 30.12.2015
      ...
      openMultiConfirm:
        'Stai cercando di aprire $1 files. Sei sicuro di volerli aprire nel browser?', // from v2.1.12 added 5.14.2016
      ...
      emptyIncSearch:
        "Nessun risultato di ricerca nella vista corrente\\APremere [Invio] per espandere l'oggetto della ricerca.", // from v2.1.16 added 5.10.2016
      emptyLetSearch:
        'Nessun risultato di ricerca tramite prima lettera nella vista corrente.', // from v2.1.23 added 24.3.2017
      ...
      renameMultiple:
        'Sei sicuro di voler rinominare $1 selezionati come $2?<br/>Questo non può essere annullato!', // from v2.1.31 added 4.12.2017
      ...
      reflectOnImmediate:
        'Tutti i cambiamenti saranno immeditamente applicati.', // from v2.1.33 added 2.3.2018
      reflectOnUnmount:
        'Qualsiasi modifica non sarà visibile fino a quando non si monta questo volume.', // from v2.1.33 added 2.3.2018
      unmountChildren:
