...
(function (root, factory) {
  ...
  elFinder.prototype.i18.es = {
    translator:
      'Julián Torres &lt;julian.torres@pabernosmatao.com&gt;, Luis Faura &lt;luis@luisfaura.es&gt;, Adrià Vilanova &lt;me@avm99963.tk&gt;, Wilman Marín Duran &lt;fuclo05@hotmail.com&gt;',
    ...
    messages: {
      ...
      errUploadTemp:
        'No se ha podido crear el archivo temporal para la subida.', // from v2.1 added 26.09.2015
      errNotReplace:
        'El objeto "$1" ya existe y no puede ser reemplazado por otro con otro tipo.', // new
      ...
      errArcSymlinks:
        'Por razones de seguridad no se pueden descomprimir archivos que contengan enlaces simbólicos.', // edited 24.06.2012
      ...
      errNotUTF8Content:
        'El archivo "$1" no está en formato UTF-8 y no puede ser editado.', // added 9.11.2011
      ...
      errFtpDownloadFile:
        'No se ha podido descargar el archivo desde FTP: "$1"',
      ...
      errExtractExec:
        'Se ha producido un error durante la extracción de archivos: "$1"',
      ...
      errFolderUpload:
        'Prueba con un navegador moderno, si quieres subir la carpeta completa.', // from v2.1 added 26.6.2015
      errSearchTimeout:
        'Se agotó el tiempo de espera buscando "$1". Los resultados de búsqueda son parciales.', // from v2.1 added 12.1.2016
      ...
      errRestore:
        'No se puede restaurar desde la papelera. No se puede identificar el destino de restauración.', // from v2.1.24 added 3.5.2017
      ...
      confirmRm:
        '¿Está seguro de querer eliminar archivos?<br/>¡Esto no se puede deshacer!',
      confirmRepl: '¿Reemplazar el antiguo archivo con el nuevo?',
      confirmRest:
        '¿Reemplazar elemento existente con el elemento en la papelera?', // fromv2.1.24 added 5.5.2017
      confirmConvUTF8:
        'No está en UTF-8<br/>Convertir a UTF-8?<br/>Los contenidos se guardarán en UTF-8 tras la conversión.', // from v2.1 added 08.04.2014
      confirmNonUTF8:
        'Codificación de caracteres de este archivo no pudo ser detectada. Es necesario convertir temporalmente a UTF-8 para editarlo. <br/> Por favor, seleccione la codificación de caracteres de este archivo.', // from v2.1.19 added 28.11.2016
      confirmNotSave:
        'Ha sido modificado.<br/>Perderás los cambios si no los guardas.', // from v2.1 added 15.7.2015
      confirmTrash:
        '¿Estás seguro que quieres mover los elementos a la papelera?', //from v2.1.24 added 29.4.2017
      ...
      emptyFolderDrop:
        'La carpeta está vacía\\A Arrastrar para añadir elementos', // from v2.1.6 added 30.12.2015
      emptyFolderLTap:
        'La carpeta está vacía\\A Presiona durante un rato para añadir elementos', // from v2.1.6 added 30.12.2015
      ...
      openMultiConfirm:
        'Estás tratando de abrir los $1 archivos. ¿Estás seguro que quieres abrir en el navegador?', // from v2.1.12 added 5.14.2016
      ...
      incSearchOnly:
        'La búsqueda incremental solo se realiza desde la vista actual.', // from v2.1.13 added 6.30.2016
      ...
      emptyIncSearch:
        'Los resultados de la búsqueda están vacíos en la vista actual. \\ APulse [Intro] para expandir el objetivo de búsqueda.', // from v2.1.16 added 5.10.2016
      emptyLetSearch:
        'La primera letra de los resultados de búsqueda está vacía en la vista actual.', // from v2.1.23 added 24.3.2017
      ...
      tooManyToTrash:
        'Son demasiados elementos, por lo que no puede enviarse a la papelera.', // from v2.1.25 added 9.6.2017
      ...
      clearBrowserData:
        'Inicializa la configuración guardada en este navegador', // from v2.1.26 added 28.6.2017
      ...
      renameMultiple:
        '¿Estás seguro que quieres renombrar $1 elementos seleccionados como $2?<br/>¡Esto no puede ser deshecho!', // from v2.1.31 added 4.12.2017
      ...
      reflectOnImmediate:
        'Todos los cambios se reflejarán inmediatamente en el archivo.', // from v2.1.33 added 2.3.2018
      reflectOnUnmount:
        'Cualquier cambio no se reflejará hasta que no se desmonte este volumen.', // from v2.1.33 added 2.3.2018
      unmountChildren:
        'Los siguientes volúmenes montados en este volumen también se desmontaron. ¿Estás seguro de desmontarlo?', // from v2.1.33 added 5.3.2018
